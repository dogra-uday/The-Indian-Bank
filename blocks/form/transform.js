...
export default class DocBasedFormToAF {
  ...
  /**
     ...
     */
  transform(exData, { name, style } = { name: 'Form' }) {
    this.errors = [];
    if (exData?.adaptiveform) {
      if (style) { exData.properties = exData.properties || {}; exData.properties.style = style; }
    ...
    if (style) { formDef.properties.style = style; }
    return formDef;
  }
